...
const appModal = document.getElementById("modal-container");
...
let activeRealtimeGroupId = "";
let activeRealtimeIsAdmin = false;
let groupFinanceUnsub = null;
let groupMembersUnsub = null;
let pendingRequestsUnsub = null;
